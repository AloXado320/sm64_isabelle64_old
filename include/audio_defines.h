...
#define SOUND_ACTION_SNOW_STEP_TEST             SOUND_ARG_LOAD(0, 4, 0x16, 0x80, 8)
...
#define SOUND_MENU_APPOPEN_ACNH                             SOUND_ARG_LOAD(7, 0, 0x01, 0xF0, 8)
#define SOUND_MENU_HOVER_ACNH                               SOUND_ARG_LOAD(7, 0, 0x02, 0xF0, 8)
//#define SOUND_MENU_PAUSE_HIGHPRIO                           SOUND_ARG_LOAD(7, 0, 0x02, 0xFF, 8)
#define SOUND_MENU_CLICK_ACNH                               SOUND_ARG_LOAD(7, 0, 0x03, 0xFF, 8)
...
#define SOUND_MENU_PINCH_MARIO_FACE                         SOUND_ARG_LOAD(7, 0, 0x08, 0x00, 8) //! Not true anymore

#define SOUND_MENU_BALLOON_CLICK                            SOUND_ARG_LOAD(7, 0, 0x08, 0x00, 8)
...
#define SOUND_MENU_N64_INTRO_SCREEN                         SOUND_ARG_LOAD(7, 0, 0x1B, 0xB0, 8)
#define SOUND_MENU_RACE_FANFARE                             SOUND_ARG_LOAD(7, 0, 0x1C, 0xB0, 8)
