...
N64_CFLAGS := -nostdinc -I include/libc -DTARGET_N64 -D_LANGUAGE_C -DNO_LDIV -DMULTILANGUAGE
...
ifeq ($(MULTILANGUAGE),1)
  CC_CHECK += -DMULTILANGUAGE
  CFLAGS += -DMULTILANGUAGE
endif
...
ifeq ($(MULTILANGUAGE),1)
TEXT_DIRS := text/us text/fr text/de text/it text/es

# EU encoded text inserted into individual segment 0x19 files,
# and course data also duplicated in leveldata.c
$(BUILD_DIR)/bin/translation_en.o: $(BUILD_DIR)/text/us/define_text.inc.c
$(BUILD_DIR)/bin/translation_fr.o: $(BUILD_DIR)/text/fr/define_text.inc.c
$(BUILD_DIR)/bin/translation_de.o: $(BUILD_DIR)/text/de/define_text.inc.c
$(BUILD_DIR)/bin/translation_it.o: $(BUILD_DIR)/text/it/define_text.inc.c
$(BUILD_DIR)/bin/translation_es.o: $(BUILD_DIR)/text/es/define_text.inc.c

$(BUILD_DIR)/levels/menu/leveldata.o: $(BUILD_DIR)/text/us/define_courses.inc.c
$(BUILD_DIR)/levels/menu/leveldata.o: $(BUILD_DIR)/text/de/define_courses.inc.c
$(BUILD_DIR)/levels/menu/leveldata.o: $(BUILD_DIR)/text/fr/define_courses.inc.c
$(BUILD_DIR)/levels/menu/leveldata.o: $(BUILD_DIR)/text/it/define_courses.inc.c
$(BUILD_DIR)/levels/menu/leveldata.o: $(BUILD_DIR)/text/es/define_courses.inc.c
...
ifeq ($(MULTILANGUAGE),1)
$(BUILD_DIR)/src/menu/file_select.o: $(BUILD_DIR)/include/text_strings.h $(BUILD_DIR)/bin/translation_en.o $(BUILD_DIR)/bin/translation_de.o $(BUILD_DIR)/bin/translation_fr.o $(BUILD_DIR)/bin/translation_it.o $(BUILD_DIR)/bin/translation_es.o
$(BUILD_DIR)/src/menu/star_select.o: $(BUILD_DIR)/include/text_strings.h $(BUILD_DIR)/bin/translation_en.o $(BUILD_DIR)/bin/translation_de.o $(BUILD_DIR)/bin/translation_fr.o $(BUILD_DIR)/bin/translation_it.o $(BUILD_DIR)/bin/translation_es.o
$(BUILD_DIR)/src/game/ingame_menu.o: $(BUILD_DIR)/include/text_strings.h $(BUILD_DIR)/bin/translation_en.o $(BUILD_DIR)/bin/translation_de.o $(BUILD_DIR)/bin/translation_fr.o $(BUILD_DIR)/bin/translation_it.o $(BUILD_DIR)/bin/translation_es.o
$(BUILD_DIR)/src/game/alternate_costume.o: $(BUILD_DIR)/include/text_strings.h $(BUILD_DIR)/bin/translation_en.o $(BUILD_DIR)/bin/translation_de.o $(BUILD_DIR)/bin/translation_fr.o $(BUILD_DIR)/bin/translation_it.o $(BUILD_DIR)/bin/translation_es.o
$(BUILD_DIR)/src/game/options_menu.o: $(BUILD_DIR)/include/text_strings.h $(BUILD_DIR)/bin/translation_en.o $(BUILD_DIR)/bin/translation_de.o $(BUILD_DIR)/bin/translation_fr.o $(BUILD_DIR)/bin/translation_it.o $(BUILD_DIR)/bin/translation_es.o
# O_FILES += $(BUILD_DIR)/bin/translation_en.o $(BUILD_DIR)/bin/translation_de.o $(BUILD_DIR)/bin/translation_fr.o
ifeq ($(TARGET_GAME_CONSOLE),0)
  ifeq ($(DISCORDRPC),1)
    $(BUILD_DIR)/src/pc/discord/discordrpc.o: $(BUILD_DIR)/include/text_strings.h $(BUILD_DIR)/bin/translation_en.o $(BUILD_DIR)/bin/translation_de.o $(BUILD_DIR)/bin/translation_fr.o $(BUILD_DIR)/bin/translation_it.o $(BUILD_DIR)/bin/translation_es.o
  endif
endif
else
...
$(ELF):  $(O_FILES) $(MIO0_FILES:.mio0=.o) $(SOUND_OBJ_FILES) $(ULTRA_O_FILES) $(BUILD_DIR)/$(RPC_LIBS)
	$(LD) -L $(BUILD_DIR) -o $@ $(O_FILES) $(SOUND_OBJ_FILES) $(ULTRA_O_FILES) $(LDFLAGS)
$(EXE): $(ELF)
	@cp $< $*.strip.elf
...
$(EXE): $(O_FILES) $(MIO0_FILES:.mio0=.o) $(SOUND_OBJ_FILES) $(ULTRA_O_FILES) $(BUILD_DIR)/src/pc/gfx/shader.shbin.o
	$(LD) -L $(BUILD_DIR) -o $@.elf $(O_FILES) $(BUILD_DIR)/src/pc/gfx/shader.shbin.o $(SOUND_OBJ_FILES) $(ULTRA_O_FILES) $(LDFLAGS)
	3dsxtool $@.elf $@
else
$(EXE): $(O_FILES) $(MIO0_FILES:.mio0=.o) $(SOUND_OBJ_FILES) $(ULTRA_O_FILES) $(BUILD_DIR)/$(RPC_LIBS)
	$(LD) -L $(BUILD_DIR) -o $@ $(O_FILES) $(SOUND_OBJ_FILES) $(ULTRA_O_FILES) $(LDFLAGS)
endif
