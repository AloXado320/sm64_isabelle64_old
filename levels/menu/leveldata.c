...
ALIGNED8 const u8 alo_file_select_border[] = {
#include "levels/menu/alo_file_select_border.rgba16.inc.c"
};

ALIGNED8 const u8 alo_file_select_select_hover[] = {
#include "levels/menu/alo_file_select_select_hover.ia8.inc.c"
};

ALIGNED8 static const u8 alo_file_select_save_slot_ci4_pal[] = {
#include "levels/menu/alo_file_select_save_slot_ci4_pal.ia16.inc.c"
};

ALIGNED8 static const u8 alo_file_select_save_slot_ci4[] = {
#include "levels/menu/alo_file_select_save_slot_ci4.inc.c"
};

const Gfx dl_alo_file_select_save_slot[] = {
    gsDPLoadTLUT_pal16(0, alo_file_select_save_slot_ci4_pal),
    gsDPLoadTextureBlock_4b(alo_file_select_save_slot_ci4, G_IM_FMT_CI, 128, 32, 0, G_TX_WRAP | G_TX_MIRROR, G_TX_WRAP | G_TX_MIRROR, 7, 5, G_TX_NOLOD, G_TX_NOLOD),
    gsSPEndDisplayList(),
};
...
#define COURSE_TABLE eu_course_strings_it_table
#include "text/it/define_courses.inc.c"
#undef COURSE_TABLE

#define COURSE_TABLE eu_course_strings_es_table
#include "text/es/define_courses.inc.c"
#undef COURSE_TABLE
