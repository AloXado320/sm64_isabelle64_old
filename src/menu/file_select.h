...
enum MenuButtonTypes {
    ...
    MENU_BUTTON_OPTION_MODE = MENU_BUTTON_ERASE_MAX,
...
#ifdef MULTILANGUAGE
    MENU_BUTTON_SOUND_MAX,
    MENU_BUTTON_LANG_MIN = MENU_BUTTON_SOUND_MAX,
    MENU_BUTTON_ENGLISH = MENU_BUTTON_LANG_MIN,
    MENU_BUTTON_FRENCH,
    MENU_BUTTON_GERMAN,
    MENU_BUTTON_ITALIAN,
    MENU_BUTTON_SPANISH,
    MENU_BUTTON_LANG_RETURN,
    MENU_BUTTON_LANG_MAX
#endif 
};
