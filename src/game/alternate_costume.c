...
void handle_alternate_costume_menu(void) {
    ...
    render_arrow_texture_menu(TRUE, ARROW_TEXTURE_SELECT, TITLE_X - 10, (sAltCustomMenuOpt * TEXT_HEIGHT) + 64);
...
void print_alternate_costume_strings(void) {
    ...
    print_generic_string_shadow(HEX_PRINT_CHR, TITLE_X, TITLE_Y, 255, 255, 255, 255, NULL, sAltCostumeTitleText[lang]);
...
// main function
void render_alternate_costume_menu(void) {
