...
const char *credits10[] = { "5Special Mentions", "PastaPower", "Fazana", "eddio0141", "Kaze", "Blake" }; // Custom Animations by PastaPower
const char *credits11[] = { "5Caneleros", "Charli Mendoza", "Erica Murphy", "Asbel Alexander", "Federico Ramos", "Franco Sanchez" };
const char *credits12[] = { "2Thank you for", "playing this", "character hack ROM" };
const char *credits13[] = { "1 ", " "}; // Custom Animations by PastaPower
const char *credits14[] = { "1 ", " "}; // buu342
const char *credits15[] = { "1 ", " "};
