...
const char *credits11[] = { "5Special Mentions", "Emil", "buu342", "Revo", "Pidgey", "Fazana" };
const char *credits12[] = { "5Grettings to", "Erica Murphy", "Asbel Alexander", "Federico Ramos", "Franco Sanchez", "Sebastian Briceño" };
const char *credits13[] = { "3Best Friends", "Charli Mendoza", "Mauricio Garcia", "Christian Manuel" };
const char *credits14[] = { "2Thank you for", "playing this", "SM64 character mod" };
