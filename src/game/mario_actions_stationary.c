...
s32 act_coughing(struct MarioState *m) {
    ...
    change_isabelle_face_expression(m, changeFace ? ISABELLE_EYES_WORRIED : ISABELLE_EYES_SAD, changeFace ? ISABELLE_MOUTH_VERY_OPEN : ISABELLE_MOUTH_SAD);
    return FALSE;
}
...
s16 sIsabelleWalkedHeavyObj = FALSE;
