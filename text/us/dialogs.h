...
Isabelle's camera, which\n\
is directly behind him.\n\
Press [R] again to return\n\
to Lakitu's camera. Press\n\
[C]↓ to see Isabelle from\n\
afar, using either\n\
Lakitu's or Isabelle's view."))
...
Isabelle's camera. It\n\
always follows Isabelle.\n\
...
// unused
DEFINE_DIALOG(DIALOG_099, NPCNAME_NONE, 2, 58, 114, _("\
Hola gente canelera!\n\
