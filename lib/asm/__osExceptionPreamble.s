...
.L80326750:
    ...
    lui   $k0, %hi(D_80334890_fix + 0x10) # $k0, 0x8033
    lw    $k0, %lo(D_80334890_fix + 0x10)($k0)
    ld    $t1, 0x20($t0)
    sd    $t1, 0x20($k0)
    ld    $t1, 0x118($t0)
    sd    $t1, 0x118($k0)
...
.L80326B14:
    ...
    jal   send_mesg
     li    $a0, 112
    lui   $t2, %hi(D_80334890_fix + 0x8) # $t2, 0x8033
    lw    $t2, %lo(D_80334890_fix + 0x8)($t2)
    li    $at, -4097
    and   $s0, $s0, $at
    lw    $k1, 0x118($t2)
    and   $k1, $k1, $at
...
glabel L80326B9C
    ...
    beqz  $at, .L80326BD0
     nop
    lui   $a0, %hi(D_80334890_fix + 0x8) # $a0, 0x8033
    move  $a1, $k0
    jal   __osEnqueueThread
     addiu $a0, %lo(D_80334890_fix + 0x8) # addiu $a0, $a0, 0x4898
    j     __osDispatchThread
     nop

.L80326BD0:
    lui   $t1, %hi(D_80334890_fix + 0x8) # $t1, 0x8033
    addiu $t1, %lo(D_80334890_fix + 0x8) # addiu $t1, $t1, 0x4898
    lw    $t2, ($t1)
    sw    $t2, ($k0)
    j     __osDispatchThread
     sw    $k0, ($t1)
...
.L80326BE8:
glabel L80326BE8
    lui   $at, %hi(D_80334890_fix + 0x14) # $at, 0x8033
    sw    $k0, %lo(D_80334890_fix + 0x14)($at)
    li    $t1, 1
    sh    $t1, 0x10($k0)
    li    $t1, 2
    sh    $t1, 0x12($k0)
...
.else
  ...
  mfc0  $t0, $13
  move  $t0, $k0
  lui   $k0, %hi(D_80334890_fix + 0x10) # $k0, 0x8030
  lw    $k0, %lo(D_80334890_fix + 0x10)($k0)
  ld    $t1, 0x20($t0)
  sd    $t1, 0x20($k0)
  ld    $t1, 0x118($t0)
...
.L802F3D20:
  ...
  jal   send_mesg
   li    $a0, 112
  lui   $t2, %hi(D_80334890_fix + 0x8) # $t2, 0x8030
  lw    $t2, %lo(D_80334890_fix + 0x8)($t2)
  li    $at, -4097
  and   $s0, $s0, $at
  lw    $k1, 0x118($t2)
...
glabel L80326B9C
  ...
  beqz  $at, .L80326BD0
   nop   
  lui   $a0, %hi(D_80334890_fix + 0x8) # $a0, 0x8030
  move  $a1, $k0
  jal   __osEnqueueThread
   addiu $a0, %lo(D_80334890_fix + 0x8) # addiu $a0, $a0, 0x2ef8
  j     __osDispatchThread
   nop   

.L80326BD0:
  lui   $t1, %hi(D_80334890_fix + 0x8) # $t1, 0x8030
  addiu $t1, %lo(D_80334890_fix + 0x8) # addiu $t1, $t1, 0x2ef8
  lw    $t2, ($t1)
  sw    $t2, ($k0)
  j     __osDispatchThread
   sw    $k0, ($t1)
...
.L80326BE8:
glabel L80326BE8
  lui   $at, %hi(D_80334890_fix + 0x14) # $at, 0x8030
  sw    $k0, %lo(D_80334890_fix + 0x14)($at)
  li    $t1, 1
  sh    $t1, 0x10($k0)
  li    $t1, 2
...
glabel __osEnqueueAndYield
    lui   $a1, %hi(D_80334890_fix + 0x10) # $a1, 0x8033
    lw    $a1, %lo(D_80334890_fix + 0x10)($a1)
    mfc0  $t0, $12
    lw    $k1, 0x18($a1)
    ori   $t0, $t0, 2
    sw    $t0, 0x118($a1)
...
glabel __osDispatchThread
    ...
    jal   __osPopThread
     addiu $a0, %lo(D_80334890_fix + 0x8) # addiu $a0, $a0, 0x4898
    lui   $at, %hi(D_80334890_fix + 0x10) # $at, 0x8033
    sw    $v0, %lo(D_80334890_fix + 0x10)($at)
    li    $t0, 4
    sh    $t0, 0x10($v0)
    move  $k0, $v0
